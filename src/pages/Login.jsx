...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 selection:bg-primary selection:text-white">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl w-full p-8 sm:p-10 space-y-8 border border-gray-100">
        <div className="text-center">
          ...
          <p className="text-gray-500 mt-2 text-sm font-medium">Please sign in to your account</p>
        </div>
